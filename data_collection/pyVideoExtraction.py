...
# def export_cropped_frame(object_name, counter, image):

# def export_filpped_frame(object_name, counter, image):
#     cv2.imwrite("frames/{}_%d.png".format(object_name) % counter, cv2.flip(image, 1))
